...
describe('DbAddAccount Usecase', () => {
	test('Should call Encrypter with correct password', async () => {
		...
		// queremos garantir que o nosso encrypter seja chamado com o password correto
	...
	test('Should throw if Encrypter throws exception', async () => {
		...
		// queremos garantir que excessoes serão passadar pra frente e não tratadas no db-add-account
